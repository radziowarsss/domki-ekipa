...
const SCENES: Scene[] = [
  {
    ...
    lines: [
      ...
      'Trzech ziomali, jedna legenda: Radzio, Lewy i Beścik.',
    ],
    accent: '#54d6c4',
    accent2: '#c084fc',
    orbs: [
  ...
  {
    glyph: '🦋',
    overline: 'Akt I — Wielki Odwrót',
    heading: 'Wielki Odwrót',
    lines: [
      'Miało być sześcioro — kocyki, jezioro, motyle w brzuchu.',
      'Lecz o świcie dziewczyny zwinęły manatki i dały dyla z planu…',
      'i tak z wielkiej wyprawy została TWARDA TRÓJKA.',
    ],
    accent: '#ff8fb1',
    accent2: '#54d6c4',
    orbs: [
  ...
  },
  {
    ...
    lines: [
      'Ale Radzio Przebiegły nie z tych, co odpuszczają.',
      'Mistrz okazji, łowca promocji, smok węszący rabaty na sto mil —',
      'zamiast po prostu zadzwonić, zbudował CAŁĄ stronę i ogłosił: jedziemy w trójkę.',
    ],
    accent: '#c084fc',
    accent2: '#7c5cff',
    orbs: [
  ...
  },
  {
    ...
    lines: [
      'I tak narodziła się LEGENDA TRZECH:',
      'Radzio (mózg operacji), Lewy (siła i cennik),',
      'i Beścik (klimat) — mniej gęb, więcej browara na łepka.',
    ],
    accent: '#ffce54',
    accent2: '#54d6c4',
    orbs: [
  ...
  },
  {
    ...
    big: true,
    lines: [
      'Proroctwo dopełnione. Trójka, jedno jezioro, morze browara.',
      'Wybierz chatę. Zwołaj brygadę. Niech legenda się zacznie.',
    ],
    accent: '#54d6c4',
    accent2: '#54a0ff',
    orbs: [
