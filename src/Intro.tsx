...
const SCENES: Scene[] = [
  {
    ...
    lines: [
      ...
      'Oto opowieść o ekipie, jeziorze i browarze przeznaczenia.',
    ],
    accent: '#54d6c4',
    accent2: '#c084fc',
    orbs: [
  ...
  {
    glyph: '🦋',
    overline: 'Akt I — Zew Jeziora',
    heading: 'Zew Jeziora',
    lines: [
      'Gdzieś nad wodą czeka chata. Balia stygnie, browar się chłodzi,',
      'a jezioro nudzi się bez ekipy i szuka towarzystwa.',
      'Legenda potrzebowała tylko jednego: żeby ktoś rzucił „jedziemy".',
    ],
    accent: '#ff8fb1',
    accent2: '#54d6c4',
    orbs: [
  ...
  {
    glyph: '🐉',
    overline: 'Akt II — Łowca Okazji',
    heading: 'Łowca Okazji',
    lines: [
      'I wtedy z cienia wyłonił się ON — łowca okazji, mistrz promocji,',
      'smok węszący rabaty na sto mil i chatę idealną nad wodą.',
      'Przeczesał całe województwa i obdzwonił pół Polski, aż ją znalazł.',
    ],
    accent: '#c084fc',
    accent2: '#7c5cff',
    orbs: [
  ...
  },
  {
    ...
    lines: [
      ...
      'ekipa, jezioro gładkie jak lustro, domek nad samą wodą,',
      'ognisko i browar, co wiernie czeka na brzegu.',
    ],
    accent: '#ffce54',
    accent2: '#54d6c4',
    orbs: [
  ...
  },
  {
    ...
    big: true,
    lines: [
      'Proroctwo dopełnione. Jedno jezioro, jeden wielki browar.',
      'Wybierz chatę. Zwołaj ekipę. Niech legenda się zacznie.',
    ],
    accent: '#54d6c4',
    accent2: '#54a0ff',
    orbs: [
